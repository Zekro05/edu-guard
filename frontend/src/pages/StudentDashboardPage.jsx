...
const StudentDashboardPage = () => {
  ...
  const fetchStudentData = useCallback(async () => {
    ...
    try {
      ...
      const ownReports = allReports.filter((report) => {
        const reportStudent =
          report.student?._id ||
          report.student?.id ||
          report.studentId ||
        ...
        if (!reportStudent) return true;
        return String(reportStudent) === String(userId);
      });
  ...
  const StatCard = ({ title, value, icon, accent }) => (
    ...
    >
      ...
      <p className={`relative text-[9px] mt-4 ${theme.muted}`}>
        Based on your submitted reports
      </p>
    </motion.div>
  );
    ...
    >
      ...
      <main className="flex-1 min-w-0 overflow-y-auto">
            ...
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <p className={`text-xs sm:text-sm mt-1 ${theme.body}`}>
                  Stay informed about your guidance activity and reports.
                </p>
              </div>
            </div>
        ...
        <div className="px-4 sm:px-6 lg:px-8 xl:px-10 py-6 sm:py-8 space-y-6">
          {/* Student welcome / command center */}
          <section
            ...
            <div className="relative grid lg:grid-cols-[1.4fr_0.8fr] gap-7 items-center">
              <div>
                ...
                <p className="text-sm leading-relaxed text-green-50/80 mt-2 max-w-2xl">
                  Your guidance dashboard is here to help you speak up, stay informed,
                  and keep track of the support you receive from school.
                </p>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="rounded-2xl bg-white/10 border border-white/10 p-4">
                  ...
                  <p className="text-[10px] text-green-100/70 mt-1">submitted so far</p>
                </div>
                <div className="rounded-2xl bg-white/10 border border-white/10 p-4">
                  <p className="text-[9px] uppercase tracking-widest font-bold text-green-100/70">
                    In progress
                  ...
                  <p className="text-[10px] text-green-100/70 mt-1">being reviewed</p>
                </div>
              </div>
            </div>
          </section>
              ...
              {[
                {
                  ...
                  text: "Share a concern privately.",
                  icon: <FilePlus2 size={19} />,
                  path: "/reports/create",
                  accent: "green",
                },
                {
                  title: "Message guidance",
                ...
                },
                {
                  ...
                  text: "Explore helpful resources.",
          ...
          <section className="grid grid-cols-1 xl:grid-cols-[1.45fr_0.85fr] gap-6">
            ...
            <div className={`rounded-[26px] border p-4 sm:p-5 ${theme.card}`}>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className={`text-[10px] mt-0.5 ${theme.muted}`}>
                      A quick look at your latest submissions
                    </p>
                  </div>
                </div>
                <button
              ...
              {loading ? (
                ...
                <div className={`rounded-2xl border border-dashed p-8 text-center ${theme.border}`}>
                  ...
                  <p className={`text-sm font-bold mt-3 ${theme.heading}`}>No reports yet</p>
                  <p className={`text-xs mt-1 max-w-sm mx-auto ${theme.muted}`}>
                    If something is bothering you or needs attention, you can report it safely through GuidEd.
                  </p>
                  <button
                    type="button"
                    onClick={() => navigate("/reports/create")}
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        <p className={`text-xs font-bold truncate ${theme.heading}`}>
                          {report.title || report.subject || report.incidentType || "Guidance report"}
                        </p>
            ...
            <div className={`rounded-[26px] border p-5 ${theme.card}`}>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className={`text-sm font-extrabold ${theme.heading}`}>Need someone to talk to?</h3>
                  <p className={`text-[10px] mt-1 ${theme.muted}`}>Guidance support is just a message away.</p>
                </div>
              </div>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className={`text-xs font-extrabold ${theme.heading}`}>A safe space to speak up</p>
                    <p className={`text-[10px] leading-relaxed mt-1 ${theme.body}`}>
                      You can use GuidEd to report concerns, ask for help, or connect with the guidance team.
                    </p>
                  </div>
                </div>
              </div>
          ...
          {/* Student-friendly safety / privacy reminder */}
          <section className={`rounded-[26px] border p-5 sm:p-6 ${theme.card}`}>
            <div className="grid md:grid-cols-[1fr_auto] gap-5 items-center">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className={`text-sm font-extrabold ${theme.heading}`}>A little reminder</h3>
                  <p className={`text-xs leading-relaxed mt-1 max-w-2xl ${theme.body}`}>
                    When reporting an incident, share the details you are comfortable providing.
                    Clear information helps the guidance team understand what happened and respond appropriately.
                  </p>
                </div>
              </div>
          ...
          <section className={`rounded-[22px] border px-4 py-3 ${theme.subtle} ${theme.border}`}>
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <p className={`text-[10px] leading-relaxed ${theme.muted}`}>
                Dashboard data is based on your submitted reports and available guidance notifications.
              </p>
              <button
                type="button"
